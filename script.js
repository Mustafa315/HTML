...
var flag3Y  = 0;
//time-frame
var t3      = setInterval(move3, 10);
//move function
function move3() {
    if (pos3X >= 0 && pos3Y >= 0 && pos3Y < 150 && flag3X === 0 && flag3Y === 0) {
        move3Right();
    } else if (pos3X >= 150 && pos3Y >= 0 && flag3Y === 0) {
        move3Bottom();
    } else if (pos3Y >= 150 && flag3X === 150) {
        move3Left();
    } else if (pos3X >= 0 && flag3Y === 150) {
        move3Up();
    }
}
...
function move3Right() {
    pos3X += 1;
    box3.style.left = pos3X + 'px';
    if (pos3X === 150) {
        flag3X = 150;
    }
}

function move3Bottom() {
    pos3Y += 1;
    box3.style.top = pos3Y + 'px';
    if (pos3Y === 150) {
        flag3Y = 150;
    }
}
...
var flag4X          = 0;
var pos4Y           = 0;
var movingBottom    = false; // move right or left
var movingUp        = false; // move right or left
var directionUp     = false;
//time-frame
var t4      = setInterval(move4, 10);

//move function
function move4() {    
    // Stop case in case moving bottom
    if (pos4X === 0 && pos4Y >= 150) {
        directionUp = true;
        flag4X = 0;
        move4Right();
    } else if (directionUp && pos4X === 0 && pos4Y <= 0) {
        directionUp = false;
        flag4X = 0;
        move4Right();
...
function move4Bottom() {
    movingBottom = true; // move bottom ONLY !!
    pos4Y += 1;
    box4.style.top = pos4Y + 'px';
...
function move4Up() {
    movingUp = true; // move bottom ONLY !!
    pos4Y -= 1;
    box4.style.top = pos4Y + 'px';
